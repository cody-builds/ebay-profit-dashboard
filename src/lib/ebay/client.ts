  ...
  transformTransaction(ebayTransaction: Record<string, unknown>): EbayTransactionData {
    try {
      ...
      return {
        ...
        soldDate: new Date(getString(ebayTransaction.CreatedDate) || getString(ebayTransaction.PaidTime) || new Date()),
        listedDate: new Date(getString(listingDetails.StartTime) || new Date()),
